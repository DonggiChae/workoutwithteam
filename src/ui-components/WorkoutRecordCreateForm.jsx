...
export default function WorkoutRecordCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new WorkoutRecord(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "WorkoutRecordCreateForm")}
      {...rest}
    >
      <TextField
        label="Date"

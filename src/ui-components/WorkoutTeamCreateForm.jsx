...
export default function WorkoutTeamCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setNumberOfMembers(initialValues.numberOfMembers);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new WorkoutTeam(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "WorkoutTeamCreateForm")}
      {...rest}
    >
      <TextField
        label="Team name"
